...
# @Author : https://github.com/SynRGB / https://github.com/SynthesisDu
# @File : fchooser.py
# @Software : PyCharm
# https://github.com/SynRGB/Dpix
# Python 3.6.13 |Anaconda, Inc.| [MSC v.1916 64 bit (AMD64)] on win32
...
def folderChooser(title: str) -> str:
    """
    :param title: 窗口名称 The time_n of the folder chooser window
...
def fileSaver(title: str, filetypes: list, defaultextension: str, initialfile: str) -> str:
    ...
    :param initialfile: 补全文件名 Default file time_n
